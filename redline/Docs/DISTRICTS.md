...
- Sea-green flickering service tubes are the ambience. A *broken* sea-green tube is a secret cue.
...
|---|---|---|---|
| First Pursuit: the eye tracks along the ceiling and bolts a Rook who stops | Broken Lift FZ1: the Core drains while you linger and refills on hits, at half drain and floored at 1, so it never burns (D-070, D-085) | Escape Tunnel FZ3: full drain on 48 px steps, plus the ranged Watcher and two in-zone enemies to feed the Core | Collector Bay: the Collector Drone |
