"""01 LOWLIGHT: Rainline, the M7 world-skeleton stub (D0).
...
The Rainline room task replaces this whole file with the real room.
"""
import os, sys
...
BOUNDS = (-64, -300, 4224, 500)
r = RoomGen("RainlineChase", BOUNDS, "lowlight", "Lowlight", "Rainline")
...
# chase_rainline_done is set by the ChaseDirector; SecurityStation's SignalLost switch reads it.
r.declare_flags("chase_rainline_done")
