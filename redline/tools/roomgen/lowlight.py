...
r.spawn("start", 140, 0, 1, default=True, label="new game")
...
s.block(624, -768, 16, 768, "WallRight")
...
n.spawn("from_bell", 2380, -90, -1)
n.exit(-64, -196, 16, 96, "ApartmentStack", "from_roofs")
n.exit(2420, -186, 16, 96, "BellTower", "from_roofs")
...
b.spawn("from_roofs", 20, 0, 1, default=True)
b.spawn("from_lift", 20, -960, 1)
b.spawn("from_warden", 575, -1056, -1)
b.exit(-64, -96, 16, 96, "NeonRoofs", "from_bell")
